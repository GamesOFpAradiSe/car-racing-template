...
o1.push(new Opposite(random(500,560),30,50,100))  
    ...
    Matter.Body.applyForce(o1.body,{x:o1.body.position.x,y:o1.body.position.y},{x:0,y:5})
...
function keyPressed(){
if(keyCode === 68){
  Matter.Body.applyForce(player.body,{x:player.body.position.x,y:player.body.position.y},{x:0.5,y:0})
